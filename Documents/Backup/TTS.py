...
def text2speech():
    ListFace = ['Tổng Bí Thư','Chủ Tịch Nước','Thủ Tướng','Chủ Tịch Quốc Hội',
            'Võ Văn Thưởng','Trương Thị Mai','Phạm Bình Minh','Nguyễn Văn Nên',
            'Tô Lâm','Phan Đình Trạc','Trần Thanh Mẫn','Trần Tuấn Anh','Trần Cẩm Tú',
            'Phan Văn Giang','Nguyễn Hòa Bình','Nguyễn Xuân Thắng','Lương Cường',
            'Trần Tuấn Anh','Đinh Tiến Dũng','Vũ Đức Đam','Thống Đốc Ngân Hàng Nhà Nước Việt Nam',
            'Trần Sỹ Thanh','Hồ Hùng Anh','Đỗ Quang Hiển','Đỗ Minh Phú','Thái Hương',
    ...
    wb = xl.load_workbook(f'/home/hieu98/Documents/Backup/excelCreate.xlsx')
